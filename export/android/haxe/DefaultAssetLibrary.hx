...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/ogmolevel/placeholder.oel", AssetType.TEXT);
		...
		type.set ("assets/images/placeholder.png", AssetType.IMAGE);
		...
		id = "assets/data/ogmolevel/placeholder.oel";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/placeholder.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
