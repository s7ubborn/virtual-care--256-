...
::Playerchoosing_obj::__register();
::Player_obj::__register();
::Overworld_obj::__register();
...
::Healthcareworker_obj::__register();
::FSM_obj::__register();
::Elevatorentity_obj::__register();
::EReg_obj::__register();
::Doorentity_obj::__register();
...
::Background_obj::__boot();
::Date_obj::__boot();
::openfl::_legacy::AssetLibrary_obj::__boot();
::DefaultAssetLibrary_obj::__boot();
::Doorentity_obj::__boot();
::Elevatorentity_obj::__boot();
::FSM_obj::__boot();
::Healthcareworker_obj::__boot();
::Lambda_obj::__boot();
::List_obj::__boot();
::IMap_obj::__boot();
...
::Overworld_obj::__boot();
::Player_obj::__boot();
::Playerchoosing_obj::__boot();
::Reflect_obj::__boot();
