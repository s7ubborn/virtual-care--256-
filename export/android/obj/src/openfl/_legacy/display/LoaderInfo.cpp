...
{
		HX_STACK_FRAME("openfl._legacy.display.LoaderInfo","this_onComplete",0x99e9f7dc,"openfl._legacy.display.LoaderInfo.this_onComplete","openfl/_legacy/display/LoaderInfo.hx",102,0xb6d254aa)
		HX_STACK_THIS(this)
...
::openfl::_legacy::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_FRAME("openfl._legacy.display.LoaderInfo","get_bytes",0x13e243e5,"openfl._legacy.display.LoaderInfo.get_bytes","openfl/_legacy/display/LoaderInfo.hx",119,0xb6d254aa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(119)
	return this->data;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::utils::ByteArray*/ ,(int)offsetof(LoaderInfo_obj,bytes),HX_CSTRING("bytes")},
	{hx::fsBool,(int)offsetof(LoaderInfo_obj,childAllowsParent),HX_CSTRING("childAllowsParent")},
	{hx::fsObject /*::openfl::_legacy::display::DisplayObject*/ ,(int)offsetof(LoaderInfo_obj,content),HX_CSTRING("content")},
	...
	{hx::fsObject /*::openfl::_legacy::events::EventDispatcher*/ ,(int)offsetof(LoaderInfo_obj,sharedEvents),HX_CSTRING("sharedEvents")},
