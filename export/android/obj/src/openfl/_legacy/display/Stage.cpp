...
{
		HX_STACK_FRAME("openfl._legacy.display.Stage","dummyTrace",0x94b7ce9d,"openfl._legacy.display.Stage.dummyTrace","openfl/_legacy/display/Stage.hx",360,0x8b30a073)
		HX_STACK_THIS(this)
		HX_STACK_LINE(360)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),360,HX_CSTRING("openfl._legacy.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._legacy.display.Stage","__setActive",0xaa514488,"openfl._legacy.display.Stage.__setActive","openfl/_legacy/display/Stage.hx",1090,0x8b30a073)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((  (((focus->__get((int)0).StaticCast< ::openfl::_legacy::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::openfl::_legacy::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/_legacy/display/Stage.hx",1116,0x8b30a073)
						{
							HX_STACK_LINE(1116)
