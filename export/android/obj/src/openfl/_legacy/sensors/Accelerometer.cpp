...
HX_STACK_THIS(this)
{
	...
	this->muted = false;
	HX_STACK_LINE(27)
	this->setRequestedUpdateInterval(::openfl::_legacy::sensors::Accelerometer_obj::__defaultInterval);
}
;
	return null();
}
...
Void Accelerometer_obj::setRequestedUpdateInterval( Float interval){
{
		...
		if (((interval < (int)0))){
			...
			if (((interval == (int)0))){
				HX_STACK_LINE(48)
				interval = ::openfl::_legacy::sensors::Accelerometer_obj::__defaultInterval;
			}
		}
		HX_STACK_LINE(52)
		...
		HX_STACK_LINE(58)
		if ((::openfl::_legacy::sensors::Accelerometer_obj::get_isSupported())){
			HX_STACK_LINE(60)
...
Void Accelerometer_obj::__update( ){
{
		...
		HX_STACK_LINE(71)
		Dynamic data = ::openfl::_legacy::sensors::Accelerometer_obj::lime_input_get_acceleration();		HX_STACK_VAR(data,"data");
		HX_STACK_LINE(73)
...
bool Accelerometer_obj::get_isSupported( ){
	...
	HX_STACK_LINE(90)
	Dynamic _g = ::openfl::_legacy::sensors::Accelerometer_obj::lime_input_get_acceleration();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(90)
	return (_g != null());
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.sensors.Accelerometer"), hx::TCanCast< Accelerometer_obj> ,sStaticFields,sMemberFields,
...
void Accelerometer_obj::__boot()
{
	...
	lime_input_get_acceleration= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_input_get_acceleration"),(int)0);
}
