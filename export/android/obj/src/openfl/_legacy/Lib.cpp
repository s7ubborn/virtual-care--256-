...
Void Lib_obj::exit( ){
{
		...
		if (((quit != null()))){
			HX_STACK_LINE(456)
			if (((quit == ::openfl::_legacy::Lib_obj::close_dyn()))){
				HX_STACK_LINE(458)
				::Sys_obj::exit((int)0);
			}
			HX_STACK_LINE(463)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","postUICallback",0xf68580a6,"openfl._legacy.Lib.postUICallback","openfl/_legacy/Lib.hx",504,0x739f021f)
		HX_STACK_ARG(inCallback,"inCallback")
		HX_STACK_LINE(504)
		::openfl::_legacy::Lib_obj::lime_post_ui_callback(inCallback);
	}
return null();
}
...
void Lib_obj::__boot()
{
	...
	lime_post_ui_callback= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_post_ui_callback"),(int)1);
