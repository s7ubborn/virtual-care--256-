...
::String File_obj::lime_filesystem_get_special_dir( int which){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","lime_filesystem_get_special_dir",0xefbfe761,"openfl._legacy.filesystem.File.lime_filesystem_get_special_dir","openfl/_legacy/filesystem/File.hx",107,0x0d6c1524)
	HX_STACK_ARG(which,"which")
	HX_STACK_LINE(124)
	if (((::openfl::_legacy::filesystem::File_obj::jni_filesystem_get_special_dir == null()))){
		HX_STACK_LINE(126)
		Dynamic _g = ::openfl::_legacy::utils::JNI_obj::createStaticMethod(HX_CSTRING("org/haxe/lime/GameActivity"),HX_CSTRING("getSpecialDir"),HX_CSTRING("(I)Ljava/lang/String;"),null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(126)
		::openfl::_legacy::filesystem::File_obj::jni_filesystem_get_special_dir = _g;
	}
	HX_STACK_LINE(130)
	return ::openfl::_legacy::filesystem::File_obj::jni_filesystem_get_special_dir(which);
}
