...
Dynamic JNIMethod_obj::callMember( Dynamic args){
	...
	HX_STACK_LINE(297)
	return ::openfl::_legacy::utils::JNIMethod_obj::lime_jni_call_member(this->method,jobject,args);
}
...
Dynamic JNIMethod_obj::callStatic( Dynamic args){
	HX_STACK_FRAME("openfl._legacy.utils.JNIMethod","callStatic",0x9acf2dd5,"openfl._legacy.utils.JNIMethod.callStatic","openfl/_legacy/utils/JNI.hx",304,0x5c37961d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(args,"args")
	HX_STACK_LINE(304)
	return ::openfl::_legacy::utils::JNIMethod_obj::lime_jni_call_static(this->method,args);
}
...
Dynamic JNIMethod_obj::getMemberMethod( bool useArray){
	HX_STACK_FRAME("openfl._legacy.utils.JNIMethod","getMemberMethod",0x0bfddc08,"openfl._legacy.utils.JNIMethod.getMemberMethod","openfl/_legacy/utils/JNI.hx",311,0x5c37961d)
	HX_STACK_THIS(this)
...
Dynamic JNIMethod_obj::getStaticMethod( bool useArray){
	HX_STACK_FRAME("openfl._legacy.utils.JNIMethod","getStaticMethod",0x6a064d5c,"openfl._legacy.utils.JNIMethod.getStaticMethod","openfl/_legacy/utils/JNI.hx",326,0x5c37961d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(useArray,"useArray")
	HX_STACK_LINE(326)
	if ((useArray)){
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.JNIMethod"), hx::TCanCast< JNIMethod_obj> ,sStaticFields,sMemberFields,
