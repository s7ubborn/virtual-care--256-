...
Dynamic JNIStaticField_obj::get( ){
	HX_STACK_FRAME("openfl._legacy.utils.JNIStaticField","get",0x6ac442d0,"openfl._legacy.utils.JNIStaticField.get","openfl/_legacy/utils/JNI.hx",255,0x5c37961d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(255)
	return ::openfl::_legacy::utils::JNIStaticField_obj::lime_jni_get_static(this->field);
}
...
Dynamic JNIStaticField_obj::set( Dynamic value){
	...
	HX_STACK_LINE(262)
	::openfl::_legacy::utils::JNIStaticField_obj::lime_jni_set_static(this->field,value);
	HX_STACK_LINE(263)
	return value;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.JNIStaticField"), hx::TCanCast< JNIStaticField_obj> ,sStaticFields,sMemberFields,
...
{
	lime_jni_get_static= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_get_static"),(int)1);
	lime_jni_set_static= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_set_static"),(int)2);
}
