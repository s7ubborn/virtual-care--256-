...
Dynamic JNIMemberField_obj::get( Dynamic jobject){
	HX_STACK_FRAME("openfl._legacy.utils.JNIMemberField","get",0x6b2a27a4,"openfl._legacy.utils.JNIMemberField.get","openfl/_legacy/utils/JNI.hx",213,0x5c37961d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jobject,"jobject")
	HX_STACK_LINE(213)
	return ::openfl::_legacy::utils::JNIMemberField_obj::lime_jni_get_member(this->field,jobject);
}
...
Dynamic JNIMemberField_obj::set( Dynamic jobject,Dynamic value){
	...
	HX_STACK_LINE(220)
	::openfl::_legacy::utils::JNIMemberField_obj::lime_jni_set_member(this->field,jobject,value);
	HX_STACK_LINE(221)
	return value;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.JNIMemberField"), hx::TCanCast< JNIMemberField_obj> ,sStaticFields,sMemberFields,
...
{
	lime_jni_get_member= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_get_member"),(int)2);
	lime_jni_set_member= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_set_member"),(int)3);
}
