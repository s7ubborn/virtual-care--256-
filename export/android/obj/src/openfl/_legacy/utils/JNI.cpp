...
Dynamic JNI_obj::createInterface( Dynamic haxeClass,::String className,::String classDef){
	...
	HX_STACK_LINE(61)
	if ((!(::openfl::_legacy::utils::JNI_obj::alreadyCreated->get(className)))){
		HX_STACK_LINE(63)
		::String _g = ::haxe::crypto::BaseCode_obj::decode(classDef,::openfl::_legacy::utils::JNI_obj::base64);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(63)
		...
		bytes = _g2;
		HX_STACK_LINE(65)
		::openfl::_legacy::utils::JNI_obj::alreadyCreated->set(className,true);
	}
	HX_STACK_LINE(69)
	return null();
}
...
::openfl::_legacy::utils::JNIMemberField JNI_obj::createMemberField( ::String className,::String memberName,::String signature){
	...
	HX_STACK_LINE(79)
	Dynamic _g = ::openfl::_legacy::utils::JNI_obj::lime_jni_create_field(className,memberName,signature,false);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(79)
	return ::openfl::_legacy::utils::JNIMemberField_obj::__new(_g);
}
	...
	HX_STACK_ARG(quietFail,"quietFail")
{
		...
		className = _g;
		HX_STACK_LINE(89)
		Dynamic handle = ::openfl::_legacy::utils::JNI_obj::lime_jni_create_method(className,memberName,signature,false,quietFail);		HX_STACK_VAR(handle,"handle");
		HX_STACK_LINE(91)
		if (((handle == null()))){
			HX_STACK_LINE(93)
			if ((quietFail)){
		...
		HX_STACK_LINE(103)
		::openfl::_legacy::utils::JNIMethod method = ::openfl::_legacy::utils::JNIMethod_obj::__new(handle);		HX_STACK_VAR(method,"method");
		HX_STACK_LINE(104)
...
::openfl::_legacy::utils::JNIStaticField JNI_obj::createStaticField( ::String className,::String memberName,::String signature){
	...
	::openfl::_legacy::utils::JNI_obj::init();
	HX_STACK_LINE(113)
	Dynamic _g = ::openfl::_legacy::utils::JNI_obj::lime_jni_create_field(className,memberName,signature,true);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(113)
	return ::openfl::_legacy::utils::JNIStaticField_obj::__new(_g);
}
	...
	HX_STACK_ARG(quietFail,"quietFail")
{
		...
		className = _g;
		HX_STACK_LINE(123)
		Dynamic handle = ::openfl::_legacy::utils::JNI_obj::lime_jni_create_method(className,memberName,signature,true,quietFail);		HX_STACK_VAR(handle,"handle");
		HX_STACK_LINE(125)
		if (((handle == null()))){
			HX_STACK_LINE(127)
			if ((quietFail)){
...
Dynamic JNI_obj::getEnv( ){
	...
	::openfl::_legacy::utils::JNI_obj::init();
	HX_STACK_LINE(147)
	return ::openfl::_legacy::utils::JNI_obj::lime_jni_get_env();
}
...
Void JNI_obj::init( ){
{
		HX_STACK_FRAME("openfl._legacy.utils.JNI","init",0xa26141da,"openfl._legacy.utils.JNI.init","openfl/_legacy/utils/JNI.hx",154,0x5c37961d)
		HX_STACK_LINE(154)
		if ((!(::openfl::_legacy::utils::JNI_obj::initialized))){
			HX_STACK_LINE(156)
			::openfl::_legacy::utils::JNI_obj::initialized = true;
			HX_STACK_LINE(157)
			Dynamic method = ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_init_callback"),(int)1);		HX_STACK_VAR(method,"method");
			HX_STACK_LINE(158)
			method(::openfl::_legacy::utils::JNI_obj::onCallback_dyn());
		}
	}
return null();
}
...
Dynamic JNI_obj::onCallback( Dynamic object,Dynamic method,Dynamic args){
	...
	HX_STACK_LINE(175)
	::haxe::Log_obj::trace(_g1,hx::SourceInfo(HX_CSTRING("JNI.hx"),175,HX_CSTRING("openfl._legacy.utils.JNI"),HX_CSTRING("onCallback")));
	HX_STACK_LINE(176)
	return null();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.JNI"), hx::TCanCast< JNI_obj> ,sStaticFields,sMemberFields,
...
void JNI_obj::__boot()
{
	...
	initialized= false;
	lime_jni_create_field= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_create_field"),(int)4);
	lime_jni_create_method= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_create_method"),(int)5);
	lime_jni_get_env= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_get_env"),(int)0);
	lime_jni_call_member= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_call_member"),(int)3);
	lime_jni_call_static= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_jni_call_static"),(int)2);
}
