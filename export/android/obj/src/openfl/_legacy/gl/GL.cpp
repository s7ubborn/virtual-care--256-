...
Void GL_obj::activeTexture( int texture){
{
		...
		HX_STACK_LINE(438)
		::openfl::_legacy::gl::GL_obj::lime_gl_active_texture(texture);
	}
return null();
}
...
Void GL_obj::attachShader( ::openfl::_legacy::gl::GLProgram program,::openfl::_legacy::gl::GLShader shader){
{
		...
		HX_STACK_LINE(443)
		::openfl::_legacy::gl::GL_obj::lime_gl_attach_shader(program->id,shader->id);
	}
return null();
}
...
Void GL_obj::bindAttribLocation( ::openfl::_legacy::gl::GLProgram program,int index,::String name){
{
		...
		HX_STACK_LINE(448)
		::openfl::_legacy::gl::GL_obj::lime_gl_bind_attrib_location(program->id,index,name);
	}
return null();
}
...
Void GL_obj::bindBitmapDataTexture( ::openfl::_legacy::display::BitmapData texture){
{
		...
		HX_STACK_ARG(texture,"texture")
		HX_STACK_LINE(453)
		::openfl::_legacy::gl::GL_obj::lime_gl_bind_bitmap_data_texture(texture->__handle);
	}
return null();
}
...
Void GL_obj::bindBuffer( int target,::openfl::_legacy::gl::GLBuffer buffer){
{
		...
		HX_STACK_LINE(458)
		::openfl::_legacy::gl::GL_obj::lime_gl_bind_buffer(target,(  (((buffer == null()))) ? Dynamic(null()) : Dynamic(buffer->id) ));
	}
return null();
}
...
Void GL_obj::bindFramebuffer( int target,::openfl::_legacy::gl::GLFramebuffer framebuffer){
{
		...
		HX_STACK_LINE(466)
		::openfl::_legacy::gl::GL_obj::lime_gl_bind_framebuffer(target,(  (((framebuffer == null()))) ? Dynamic(null()) : Dynamic(framebuffer->id) ));
	}
return null();
}
...
Void GL_obj::bindRenderbuffer( int target,::openfl::_legacy::gl::GLRenderbuffer renderbuffer){
{
		...
		HX_STACK_LINE(471)
		::openfl::_legacy::gl::GL_obj::lime_gl_bind_renderbuffer(target,(  (((renderbuffer == null()))) ? Dynamic(null()) : Dynamic(renderbuffer->id) ));
	}
return null();
}
...
Void GL_obj::bindTexture( int target,::openfl::_legacy::gl::GLTexture texture){
{
		...
		HX_STACK_ARG(texture,"texture")
		HX_STACK_LINE(476)
		::openfl::_legacy::gl::GL_obj::lime_gl_bind_texture(target,(  (((texture == null()))) ? Dynamic(null()) : Dynamic(texture->id) ));
	}
return null();
}
...
Void GL_obj::blendColor( Float red,Float green,Float blue,Float alpha){
{
		...
		HX_STACK_LINE(481)
		::openfl::_legacy::gl::GL_obj::lime_gl_blend_color(red,green,blue,alpha);
	}
return null();
}
...
Void GL_obj::blendEquation( int mode){
{
		...
		HX_STACK_LINE(486)
		::openfl::_legacy::gl::GL_obj::lime_gl_blend_equation(mode);
	}
return null();
}
...
Void GL_obj::blendEquationSeparate( int modeRGB,int modeAlpha){
{
		...
		HX_STACK_LINE(491)
		::openfl::_legacy::gl::GL_obj::lime_gl_blend_equation_separate(modeRGB,modeAlpha);
	}
return null();
}
...
Void GL_obj::blendFunc( int sfactor,int dfactor){
{
		...
		HX_STACK_LINE(496)
		::openfl::_legacy::gl::GL_obj::lime_gl_blend_func(sfactor,dfactor);
	}
return null();
}
...
Void GL_obj::blendFuncSeparate( int srcRGB,int dstRGB,int srcAlpha,int dstAlpha){
{
		...
		HX_STACK_LINE(501)
		::openfl::_legacy::gl::GL_obj::lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
	}
return null();
}
...
Void GL_obj::bufferData( int target,::openfl::_legacy::utils::IMemoryRange data,int usage){
{
		...
		HX_STACK_LINE(506)
		::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data(target,_g,_g1,_g2,usage);
	}
return null();
}
...
Void GL_obj::bufferSubData( int target,int offset,::openfl::_legacy::utils::IMemoryRange data){
{
		...
		int _g2 = data->getLength();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(511)
		::openfl::_legacy::gl::GL_obj::lime_gl_buffer_sub_data(target,offset,_g,_g1,_g2);
	}
return null();
}
...
int GL_obj::checkFramebufferStatus( int target){
	...
	HX_STACK_ARG(target,"target")
	HX_STACK_LINE(516)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_check_framebuffer_status(target);
}
...
Void GL_obj::clearStencil( int s){
{
		...
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(536)
		::openfl::_legacy::gl::GL_obj::lime_gl_clear_stencil(s);
	}
return null();
}
...
Void GL_obj::compileShader( ::openfl::_legacy::gl::GLShader shader){
{
		...
		HX_STACK_ARG(shader,"shader")
		HX_STACK_LINE(546)
		::openfl::_legacy::gl::GL_obj::lime_gl_compile_shader(shader->id);
	}
return null();
}
...
Void GL_obj::compressedTexImage2D( int target,int level,int internalformat,int width,int height,int border,::openfl::_legacy::utils::IMemoryRange data){
{
		...
		HX_STACK_LINE(551)
		::openfl::_legacy::gl::GL_obj::lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,_g,_g1);
	}
return null();
}
...
Void GL_obj::compressedTexSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,::openfl::_legacy::utils::IMemoryRange data){
{
		...
		HX_STACK_LINE(556)
		::openfl::_legacy::gl::GL_obj::lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,_g,_g1);
	}
return null();
}
...
Void GL_obj::copyTexImage2D( int target,int level,int internalformat,int x,int y,int width,int height,int border){
{
		...
		HX_STACK_ARG(border,"border")
		HX_STACK_LINE(561)
		::openfl::_legacy::gl::GL_obj::lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
	}
return null();
}
...
Void GL_obj::copyTexSubImage2D( int target,int level,int xoffset,int yoffset,int x,int y,int width,int height){
{
		...
		HX_STACK_ARG(height,"height")
		HX_STACK_LINE(566)
		::openfl::_legacy::gl::GL_obj::lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
	}
return null();
}
...
::openfl::_legacy::gl::GLBuffer GL_obj::createBuffer( ){
	...
	HX_STACK_LINE(571)
	return ::openfl::_legacy::gl::GLBuffer_obj::__new(_g,_g1);
}
...
::openfl::_legacy::gl::GLFramebuffer GL_obj::createFramebuffer( ){
	...
	HX_STACK_LINE(576)
	return ::openfl::_legacy::gl::GLFramebuffer_obj::__new(_g,_g1);
}
...
::openfl::_legacy::gl::GLProgram GL_obj::createProgram( ){
	...
	HX_STACK_LINE(581)
	return ::openfl::_legacy::gl::GLProgram_obj::__new(_g,_g1);
}
...
::openfl::_legacy::gl::GLRenderbuffer GL_obj::createRenderbuffer( ){
	...
	int _g = ::openfl::_legacy::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(586)
	Dynamic _g1 = ::openfl::_legacy::gl::GL_obj::lime_gl_create_render_buffer();		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(586)
	return ::openfl::_legacy::gl::GLRenderbuffer_obj::__new(_g,_g1);
}
...
::openfl::_legacy::gl::GLShader GL_obj::createShader( int type){
	...
	int _g = ::openfl::_legacy::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(591)
	Dynamic _g1 = ::openfl::_legacy::gl::GL_obj::lime_gl_create_shader(type);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(591)
	return ::openfl::_legacy::gl::GLShader_obj::__new(_g,_g1);
}
...
::openfl::_legacy::gl::GLTexture GL_obj::createTexture( ){
	...
	HX_STACK_LINE(596)
	return ::openfl::_legacy::gl::GLTexture_obj::__new(_g,_g1);
}
...
Void GL_obj::cullFace( int mode){
{
		...
		HX_STACK_ARG(mode,"mode")
		HX_STACK_LINE(601)
		::openfl::_legacy::gl::GL_obj::lime_gl_cull_face(mode);
	}
return null();
}
...
Void GL_obj::deleteProgram( ::openfl::_legacy::gl::GLProgram program){
{
		...
		HX_STACK_ARG(program,"program")
		HX_STACK_LINE(618)
		::openfl::_legacy::gl::GL_obj::lime_gl_delete_program(program->id);
		HX_STACK_LINE(619)
		program->invalidate();
	}
return null();
...
Void GL_obj::deleteRenderbuffer( ::openfl::_legacy::gl::GLRenderbuffer renderbuffer){
{
		...
		HX_STACK_ARG(renderbuffer,"renderbuffer")
		HX_STACK_LINE(624)
		::openfl::_legacy::gl::GL_obj::lime_gl_delete_render_buffer(renderbuffer->id);
		HX_STACK_LINE(625)
...
Void GL_obj::deleteShader( ::openfl::_legacy::gl::GLShader shader){
{
		...
		HX_STACK_ARG(shader,"shader")
		HX_STACK_LINE(630)
		::openfl::_legacy::gl::GL_obj::lime_gl_delete_shader(shader->id);
		HX_STACK_LINE(631)
		shader->invalidate();
	}
return null();
...
Void GL_obj::deleteTexture( ::openfl::_legacy::gl::GLTexture texture){
{
		...
		HX_STACK_ARG(texture,"texture")
		HX_STACK_LINE(636)
		::openfl::_legacy::gl::GL_obj::lime_gl_delete_texture(texture->id);
		HX_STACK_LINE(637)
		texture->invalidate();
	}
return null();
...
Void GL_obj::depthFunc( int func){
{
		...
		HX_STACK_LINE(642)
		::openfl::_legacy::gl::GL_obj::lime_gl_depth_func(func);
	}
return null();
}
...
Void GL_obj::depthMask( bool flag){
{
		...
		HX_STACK_LINE(647)
		::openfl::_legacy::gl::GL_obj::lime_gl_depth_mask(flag);
	}
return null();
}
...
Void GL_obj::depthRange( Float zNear,Float zFar){
{
		...
		HX_STACK_LINE(652)
		::openfl::_legacy::gl::GL_obj::lime_gl_depth_range(zNear,zFar);
	}
return null();
}
...
Void GL_obj::detachShader( ::openfl::_legacy::gl::GLProgram program,::openfl::_legacy::gl::GLShader shader){
{
		...
		HX_STACK_ARG(shader,"shader")
		HX_STACK_LINE(657)
		::openfl::_legacy::gl::GL_obj::lime_gl_detach_shader(program->id,shader->id);
	}
return null();
}
...
Void GL_obj::disable( int cap){
{
		...
		HX_STACK_LINE(662)
		::openfl::_legacy::gl::GL_obj::lime_gl_disable(cap);
	}
return null();
}
...
Void GL_obj::disableVertexAttribArray( int index){
{
		...
		HX_STACK_ARG(index,"index")
		HX_STACK_LINE(667)
		::openfl::_legacy::gl::GL_obj::lime_gl_disable_vertex_attrib_array(index);
	}
return null();
}
...
Void GL_obj::drawArrays( int mode,int first,int count){
{
		...
		HX_STACK_LINE(672)
		::openfl::_legacy::gl::GL_obj::lime_gl_draw_arrays(mode,first,count);
	}
return null();
}
...
Void GL_obj::drawElements( int mode,int count,int type,int offset){
{
		...
		HX_STACK_ARG(offset,"offset")
		HX_STACK_LINE(677)
		::openfl::_legacy::gl::GL_obj::lime_gl_draw_elements(mode,count,type,offset);
	}
return null();
}
...
Void GL_obj::enable( int cap){
{
		...
		HX_STACK_ARG(cap,"cap")
		HX_STACK_LINE(682)
		::openfl::_legacy::gl::GL_obj::lime_gl_enable(cap);
	}
return null();
}
...
Void GL_obj::enableVertexAttribArray( int index){
{
		...
		HX_STACK_ARG(index,"index")
		HX_STACK_LINE(687)
		::openfl::_legacy::gl::GL_obj::lime_gl_enable_vertex_attrib_array(index);
	}
return null();
}
...
Void GL_obj::framebufferRenderbuffer( int target,int attachment,int renderbuffertarget,::openfl::_legacy::gl::GLRenderbuffer renderbuffer){
{
		...
		HX_STACK_ARG(renderbuffer,"renderbuffer")
		HX_STACK_LINE(702)
		::openfl::_legacy::gl::GL_obj::lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,renderbuffer->id);
	}
return null();
}
...
Void GL_obj::framebufferTexture2D( int target,int attachment,int textarget,::openfl::_legacy::gl::GLTexture texture,int level){
{
		...
		HX_STACK_ARG(level,"level")
		HX_STACK_LINE(707)
		::openfl::_legacy::gl::GL_obj::lime_gl_framebuffer_texture2D(target,attachment,textarget,texture->id,level);
	}
return null();
}
...
Void GL_obj::frontFace( int mode){
{
		...
		HX_STACK_ARG(mode,"mode")
		HX_STACK_LINE(712)
		::openfl::_legacy::gl::GL_obj::lime_gl_front_face(mode);
	}
return null();
}
...
Void GL_obj::generateMipmap( int target){
{
		...
		HX_STACK_ARG(target,"target")
		HX_STACK_LINE(717)
		::openfl::_legacy::gl::GL_obj::lime_gl_generate_mipmap(target);
	}
return null();
}
...
Dynamic GL_obj::getActiveAttrib( ::openfl::_legacy::gl::GLProgram program,int index){
	...
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(722)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_active_attrib(program->id,index);
}
...
Dynamic GL_obj::getActiveUniform( ::openfl::_legacy::gl::GLProgram program,int index){
	...
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(727)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_active_uniform(program->id,index);
}
...
int GL_obj::getAttribLocation( ::openfl::_legacy::gl::GLProgram program,::String name){
	...
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(737)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_attrib_location(program->id,name);
}
...
Dynamic GL_obj::getBufferParameter( int target,int pname){
	...
	HX_STACK_LINE(742)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_buffer_paramerter(target,pname);
}
...
Dynamic GL_obj::getContextAttributes( ){
	...
	HX_STACK_LINE(747)
	Dynamic base = ::openfl::_legacy::gl::GL_obj::lime_gl_get_context_attributes();		HX_STACK_VAR(base,"base");
	HX_STACK_LINE(748)
...
int GL_obj::getError( ){
	...
	HX_STACK_LINE(755)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_error();
}
...
Dynamic GL_obj::getFramebufferAttachmentParameter( int target,int attachment,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(766)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname);
}
...
Dynamic GL_obj::getParameter( int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(771)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_parameter(pname);
}
...
::String GL_obj::getProgramInfoLog( ::openfl::_legacy::gl::GLProgram program){
	...
	HX_STACK_ARG(program,"program")
	HX_STACK_LINE(776)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_program_info_log(program->id);
}
...
int GL_obj::getProgramParameter( ::openfl::_legacy::gl::GLProgram program,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(781)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_program_parameter(program->id,pname);
}
...
Dynamic GL_obj::getRenderbufferParameter( int target,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(786)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_render_buffer_parameter(target,pname);
}
...
::String GL_obj::getShaderInfoLog( ::openfl::_legacy::gl::GLShader shader){
	...
	HX_STACK_ARG(shader,"shader")
	HX_STACK_LINE(791)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_shader_info_log(shader->id);
}
...
int GL_obj::getShaderParameter( ::openfl::_legacy::gl::GLShader shader,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(796)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_shader_parameter(shader->id,pname);
}
...
Dynamic GL_obj::getShaderPrecisionFormat( int shadertype,int precisiontype){
	...
	HX_STACK_LINE(801)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_shader_precision_format(shadertype,precisiontype);
}
...
::String GL_obj::getShaderSource( ::openfl::_legacy::gl::GLShader shader){
	...
	HX_STACK_ARG(shader,"shader")
	HX_STACK_LINE(806)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_shader_source(shader->id);
}
...
Dynamic GL_obj::getTexParameter( int target,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(818)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_tex_parameter(target,pname);
}
...
Dynamic GL_obj::getUniform( ::openfl::_legacy::gl::GLProgram program,Dynamic location){
	...
	HX_STACK_LINE(823)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_uniform(program->id,location);
}
...
Dynamic GL_obj::getUniformLocation( ::openfl::_legacy::gl::GLProgram program,::String name){
	...
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(828)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_uniform_location(program->id,name);
}
...
Dynamic GL_obj::getVertexAttrib( int index,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(833)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_vertex_attrib(index,pname);
}
...
int GL_obj::getVertexAttribOffset( int index,int pname){
	...
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(838)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_get_vertex_attrib_offset(index,pname);
}
...
Void GL_obj::hint( int target,int mode){
{
		...
		HX_STACK_ARG(mode,"mode")
		HX_STACK_LINE(843)
		::openfl::_legacy::gl::GL_obj::lime_gl_hint(target,mode);
	}
return null();
}
...
bool GL_obj::isBuffer( ::openfl::_legacy::gl::GLBuffer buffer){
	...
	if (((buffer != null()))){
		HX_STACK_LINE(848)
		return ::openfl::_legacy::gl::GL_obj::lime_gl_is_buffer(buffer->id);
	}
	else{
		HX_STACK_LINE(848)
		return false;
...
bool GL_obj::isEnabled( int cap){
	...
	HX_STACK_ARG(cap,"cap")
	HX_STACK_LINE(855)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_is_enabled(cap);
}
...
bool GL_obj::isFramebuffer( ::openfl::_legacy::gl::GLFramebuffer framebuffer){
	...
	if (((framebuffer != null()))){
		HX_STACK_LINE(860)
		return ::openfl::_legacy::gl::GL_obj::lime_gl_is_framebuffer(framebuffer->id);
	}
	else{
		HX_STACK_LINE(860)
		return false;
...
bool GL_obj::isProgram( ::openfl::_legacy::gl::GLProgram program){
	...
	if (((program != null()))){
		HX_STACK_LINE(865)
		return ::openfl::_legacy::gl::GL_obj::lime_gl_is_program(program->id);
	}
	else{
		HX_STACK_LINE(865)
		return false;
...
bool GL_obj::isRenderbuffer( ::openfl::_legacy::gl::GLRenderbuffer renderbuffer){
	...
	if (((renderbuffer != null()))){
		HX_STACK_LINE(870)
		return ::openfl::_legacy::gl::GL_obj::lime_gl_is_renderbuffer(renderbuffer->id);
	}
	else{
		HX_STACK_LINE(870)
		return false;
...
bool GL_obj::isShader( ::openfl::_legacy::gl::GLShader shader){
	...
	if (((shader != null()))){
		HX_STACK_LINE(875)
		return ::openfl::_legacy::gl::GL_obj::lime_gl_is_shader(shader->id);
	}
	else{
		HX_STACK_LINE(875)
		return false;
...
bool GL_obj::isTexture( ::openfl::_legacy::gl::GLTexture texture){
	...
	if (((texture != null()))){
		HX_STACK_LINE(880)
		return ::openfl::_legacy::gl::GL_obj::lime_gl_is_texture(texture->id);
	}
	else{
		HX_STACK_LINE(880)
		return false;
...
Void GL_obj::lineWidth( Float width){
{
		...
		HX_STACK_ARG(width,"width")
		HX_STACK_LINE(885)
		::openfl::_legacy::gl::GL_obj::lime_gl_line_width(width);
	}
return null();
}
...
Void GL_obj::linkProgram( ::openfl::_legacy::gl::GLProgram program){
{
		...
		HX_STACK_ARG(program,"program")
		HX_STACK_LINE(890)
		::openfl::_legacy::gl::GL_obj::lime_gl_link_program(program->id);
	}
return null();
}
...
Dynamic GL_obj::load( ::String inName,int inArgCount){
	...
	{
		HX_STACK_LINE(897)
		return ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),inName,inArgCount);
	}
	}
	catch(Dynamic __e){
		{
			...
			Dynamic e = __e;{
				HX_STACK_LINE(901)
				::haxe::Log_obj::trace(e,hx::SourceInfo(HX_CSTRING("GL.hx"),901,HX_CSTRING("openfl._legacy.gl.GL"),HX_CSTRING("load")));
				HX_STACK_LINE(902)
				return null();
			}
		}
...
Void GL_obj::pixelStorei( int pname,int param){
{
		...
		HX_STACK_LINE(908)
		::openfl::_legacy::gl::GL_obj::lime_gl_pixel_storei(pname,param);
	}
return null();
}
...
Void GL_obj::polygonOffset( Float factor,Float units){
{
		...
		HX_STACK_LINE(913)
		::openfl::_legacy::gl::GL_obj::lime_gl_polygon_offset(factor,units);
	}
return null();
}
...
Void GL_obj::readPixels( int x,int y,int width,int height,int format,int type,::openfl::_legacy::utils::ByteArray pixels){
{
		...
		HX_STACK_LINE(918)
		::openfl::_legacy::gl::GL_obj::lime_gl_read_pixels(x,y,width,height,format,type,_g,_g1);
	}
return null();
}
...
Void GL_obj::renderbufferStorage( int target,int internalformat,int width,int height){
{
		...
		HX_STACK_ARG(height,"height")
		HX_STACK_LINE(923)
		::openfl::_legacy::gl::GL_obj::lime_gl_renderbuffer_storage(target,internalformat,width,height);
	}
return null();
}
...
Void GL_obj::sampleCoverage( Float value,bool invert){
{
		...
		HX_STACK_LINE(928)
		::openfl::_legacy::gl::GL_obj::lime_gl_sample_coverage(value,invert);
	}
return null();
}
...
Void GL_obj::shaderSource( ::openfl::_legacy::gl::GLShader shader,::String source){
{
		...
		HX_STACK_LINE(938)
		::openfl::_legacy::gl::GL_obj::lime_gl_shader_source(shader->id,source);
	}
return null();
}
...
Void GL_obj::stencilFunc( int func,int ref,int mask){
{
		...
		HX_STACK_ARG(mask,"mask")
		HX_STACK_LINE(943)
		::openfl::_legacy::gl::GL_obj::lime_gl_stencil_func(func,ref,mask);
	}
return null();
}
...
Void GL_obj::stencilFuncSeparate( int face,int func,int ref,int mask){
{
		...
		HX_STACK_ARG(mask,"mask")
		HX_STACK_LINE(948)
		::openfl::_legacy::gl::GL_obj::lime_gl_stencil_func_separate(face,func,ref,mask);
	}
return null();
}
...
Void GL_obj::stencilMask( int mask){
{
		...
		HX_STACK_ARG(mask,"mask")
		HX_STACK_LINE(953)
		::openfl::_legacy::gl::GL_obj::lime_gl_stencil_mask(mask);
	}
return null();
}
...
Void GL_obj::stencilMaskSeparate( int face,int mask){
{
		...
		HX_STACK_ARG(mask,"mask")
		HX_STACK_LINE(958)
		::openfl::_legacy::gl::GL_obj::lime_gl_stencil_mask_separate(face,mask);
	}
return null();
}
...
Void GL_obj::stencilOpSeparate( int face,int fail,int zfail,int zpass){
{
		...
		HX_STACK_ARG(zpass,"zpass")
		HX_STACK_LINE(968)
		::openfl::_legacy::gl::GL_obj::lime_gl_stencil_op_separate(face,fail,zfail,zpass);
	}
return null();
}
...
Void GL_obj::texImage2D( int target,int level,int internalformat,int width,int height,int border,int format,int type,::openfl::_legacy::utils::ArrayBufferView pixels){
{
		...
		HX_STACK_LINE(973)
		::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,_g,_g1);
	}
return null();
}
...
Void GL_obj::texParameterf( int target,int pname,Float param){
{
		...
		HX_STACK_ARG(param,"param")
		HX_STACK_LINE(978)
		::openfl::_legacy::gl::GL_obj::lime_gl_tex_parameterf(target,pname,param);
	}
return null();
}
...
Void GL_obj::texParameteri( int target,int pname,int param){
{
		...
		HX_STACK_ARG(param,"param")
		HX_STACK_LINE(983)
		::openfl::_legacy::gl::GL_obj::lime_gl_tex_parameteri(target,pname,param);
	}
return null();
}
...
Void GL_obj::texSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,int type,::openfl::_legacy::utils::ArrayBufferView pixels){
{
		...
		HX_STACK_LINE(988)
		::openfl::_legacy::gl::GL_obj::lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,_g,_g1);
	}
return null();
}
...
Void GL_obj::uniform1f( Dynamic location,Float x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(993)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform1f(location,x);
	}
return null();
}
...
Void GL_obj::uniform1fv( Dynamic location,Dynamic x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(998)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform1fv(location,x);
	}
return null();
}
...
Void GL_obj::uniform1i( Dynamic location,int x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(1003)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform1i(location,x);
	}
return null();
}
...
Void GL_obj::uniform1iv( Dynamic location,Array< int > v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1008)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform1iv(location,v);
	}
return null();
}
...
Void GL_obj::uniform2f( Dynamic location,Float x,Float y){
{
		...
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(1013)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform2f(location,x,y);
	}
return null();
}
...
Void GL_obj::uniform2fv( Dynamic location,Dynamic v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1018)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform2fv(location,v);
	}
return null();
}
...
Void GL_obj::uniform2i( Dynamic location,int x,int y){
{
		...
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(1023)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform2i(location,x,y);
	}
return null();
}
...
Void GL_obj::uniform2iv( Dynamic location,Array< int > v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1028)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform2iv(location,v);
	}
return null();
}
...
Void GL_obj::uniform3f( Dynamic location,Float x,Float y,Float z){
{
		...
		HX_STACK_ARG(z,"z")
		HX_STACK_LINE(1033)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform3f(location,x,y,z);
	}
return null();
}
...
Void GL_obj::uniform3fv( Dynamic location,Dynamic v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1038)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform3fv(location,v);
	}
return null();
}
...
Void GL_obj::uniform3i( Dynamic location,int x,int y,int z){
{
		...
		HX_STACK_ARG(z,"z")
		HX_STACK_LINE(1043)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform3i(location,x,y,z);
	}
return null();
}
...
Void GL_obj::uniform3iv( Dynamic location,Array< int > v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1048)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform3iv(location,v);
	}
return null();
}
...
Void GL_obj::uniform4f( Dynamic location,Float x,Float y,Float z,Float w){
{
		...
		HX_STACK_ARG(w,"w")
		HX_STACK_LINE(1053)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform4f(location,x,y,z,w);
	}
return null();
}
...
Void GL_obj::uniform4fv( Dynamic location,Dynamic v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1058)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform4fv(location,v);
	}
return null();
}
...
Void GL_obj::uniform4i( Dynamic location,int x,int y,int z,int w){
{
		...
		HX_STACK_ARG(w,"w")
		HX_STACK_LINE(1063)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform4i(location,x,y,z,w);
	}
return null();
}
...
Void GL_obj::uniform4iv( Dynamic location,Dynamic v){
{
		...
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(1068)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform4iv(location,v);
	}
return null();
}
...
Void GL_obj::uniformMatrix2fv( Dynamic location,bool transpose,::openfl::_legacy::utils::Float32Array v){
{
		...
		HX_STACK_LINE(1078)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(location,transpose,_g,(int)2);
	}
return null();
}
...
Void GL_obj::uniformMatrix3fv( Dynamic location,bool transpose,::openfl::_legacy::utils::Float32Array v){
{
		...
		::openfl::_legacy::utils::ByteArray _g = v->getByteBuffer();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1088)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(location,transpose,_g,(int)3);
	}
return null();
}
...
Void GL_obj::uniformMatrix4fv( Dynamic location,bool transpose,::openfl::_legacy::utils::Float32Array v){
{
		...
		::openfl::_legacy::utils::ByteArray _g = v->getByteBuffer();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1099)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(location,transpose,_g,(int)4);
	}
return null();
}
...
Void GL_obj::uniformMatrix3D( Dynamic location,bool transpose,::openfl::geom::Matrix3D matrix){
{
		...
		HX_STACK_LINE(1104)
		::openfl::_legacy::utils::ByteArray _g = ::openfl::_legacy::utils::Float32Array_obj::fromMatrix(matrix)->getByteBuffer();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1104)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(location,transpose,_g,(int)4);
	}
return null();
...
Void GL_obj::useProgram( ::openfl::_legacy::gl::GLProgram program){
{
		...
		HX_STACK_ARG(program,"program")
		HX_STACK_LINE(1109)
		::openfl::_legacy::gl::GL_obj::lime_gl_use_program((  (((program == null()))) ? Dynamic(null()) : Dynamic(program->id) ));
	}
return null();
}
...
Void GL_obj::validateProgram( ::openfl::_legacy::gl::GLProgram program){
{
		...
		HX_STACK_ARG(program,"program")
		HX_STACK_LINE(1114)
		::openfl::_legacy::gl::GL_obj::lime_gl_validate_program(program->id);
	}
return null();
}
...
Void GL_obj::vertexAttrib1f( int indx,Float x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(1119)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib1f(indx,x);
	}
return null();
}
...
Void GL_obj::vertexAttrib1fv( int indx,Dynamic values){
{
		...
		HX_STACK_LINE(1124)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib1fv(indx,values);
	}
return null();
}
...
Void GL_obj::vertexAttrib2f( int indx,Float x,Float y){
{
		...
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(1129)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib2f(indx,x,y);
	}
return null();
}
...
Void GL_obj::vertexAttrib2fv( int indx,Dynamic values){
{
		...
		HX_STACK_ARG(values,"values")
		HX_STACK_LINE(1134)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib2fv(indx,values);
	}
return null();
}
...
Void GL_obj::vertexAttrib3f( int indx,Float x,Float y,Float z){
{
		...
		HX_STACK_ARG(z,"z")
		HX_STACK_LINE(1139)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib3f(indx,x,y,z);
	}
return null();
}
...
Void GL_obj::vertexAttrib3fv( int indx,Dynamic values){
{
		...
		HX_STACK_ARG(values,"values")
		HX_STACK_LINE(1144)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib3fv(indx,values);
	}
return null();
}
...
Void GL_obj::vertexAttrib4f( int indx,Float x,Float y,Float z,Float w){
{
		...
		HX_STACK_ARG(w,"w")
		HX_STACK_LINE(1149)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib4f(indx,x,y,z,w);
	}
return null();
}
...
Void GL_obj::vertexAttrib4fv( int indx,Dynamic values){
{
		...
		HX_STACK_ARG(values,"values")
		HX_STACK_LINE(1154)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib4fv(indx,values);
	}
return null();
}
...
Void GL_obj::vertexAttribPointer( int indx,int size,int type,bool normalized,int stride,int offset){
{
		...
		HX_STACK_ARG(offset,"offset")
		HX_STACK_LINE(1159)
		::openfl::_legacy::gl::GL_obj::lime_gl_vertex_attrib_pointer(indx,size,type,normalized,stride,offset);
	}
return null();
}
...
int GL_obj::get_drawingBufferHeight( ){
	...
	HX_STACK_LINE(1175)
	return ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
}
...
int GL_obj::get_drawingBufferWidth( ){
	...
	HX_STACK_LINE(1176)
	return ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
}
...
int GL_obj::get_version( ){
	...
	HX_STACK_LINE(1177)
	return ::openfl::_legacy::gl::GL_obj::lime_gl_version();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.gl.GL"), hx::TCanCast< GL_obj> ,sStaticFields,sMemberFields,
...
void GL_obj::__boot()
{
	...
	lime_gl_active_texture= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_active_texture"),(int)1);
	lime_gl_attach_shader= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_attach_shader"),(int)2);
	lime_gl_bind_attrib_location= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_bind_attrib_location"),(int)3);
	lime_gl_bind_bitmap_data_texture= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_bind_bitmap_data_texture"),(int)1);
	lime_gl_bind_buffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_bind_buffer"),(int)2);
	lime_gl_bind_framebuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_bind_framebuffer"),(int)2);
	lime_gl_bind_renderbuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_bind_renderbuffer"),(int)2);
	lime_gl_bind_texture= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_bind_texture"),(int)2);
	lime_gl_blend_color= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_blend_color"),(int)4);
	lime_gl_blend_equation= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_blend_equation"),(int)1);
	lime_gl_blend_equation_separate= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_blend_equation_separate"),(int)2);
	lime_gl_blend_func= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_blend_func"),(int)2);
	lime_gl_blend_func_separate= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_blend_func_separate"),(int)4);
	lime_gl_buffer_data= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_buffer_data"),(int)5);
	lime_gl_buffer_sub_data= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_buffer_sub_data"),(int)5);
	lime_gl_check_framebuffer_status= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_check_framebuffer_status"),(int)1);
	lime_gl_clear= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_clear"),(int)1);
	lime_gl_clear_color= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_clear_color"),(int)4);
	lime_gl_clear_depth= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_clear_depth"),(int)1);
	lime_gl_clear_stencil= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_clear_stencil"),(int)1);
	lime_gl_color_mask= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_color_mask"),(int)4);
	lime_gl_compile_shader= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_compile_shader"),(int)1);
	lime_gl_compressed_tex_image_2d= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_compressed_tex_image_2d"),(int)-1);
	lime_gl_compressed_tex_sub_image_2d= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_compressed_tex_sub_image_2d"),(int)-1);
	lime_gl_copy_tex_image_2d= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_copy_tex_image_2d"),(int)-1);
	lime_gl_copy_tex_sub_image_2d= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_copy_tex_sub_image_2d"),(int)-1);
	lime_gl_create_buffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_create_buffer"),(int)0);
	lime_gl_create_framebuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_create_framebuffer"),(int)0);
	lime_gl_create_program= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_create_program"),(int)0);
	lime_gl_create_render_buffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_create_render_buffer"),(int)0);
	lime_gl_create_shader= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_create_shader"),(int)1);
	lime_gl_create_texture= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_create_texture"),(int)0);
	lime_gl_cull_face= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_cull_face"),(int)1);
	lime_gl_delete_buffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_delete_buffer"),(int)1);
	lime_gl_delete_framebuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_delete_framebuffer"),(int)1);
	lime_gl_delete_program= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_delete_program"),(int)1);
	lime_gl_delete_render_buffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_delete_render_buffer"),(int)1);
	lime_gl_delete_shader= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_delete_shader"),(int)1);
	lime_gl_delete_texture= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_delete_texture"),(int)1);
	lime_gl_depth_func= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_depth_func"),(int)1);
	lime_gl_depth_mask= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_depth_mask"),(int)1);
	lime_gl_depth_range= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_depth_range"),(int)2);
	lime_gl_detach_shader= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_detach_shader"),(int)2);
	lime_gl_disable= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_disable"),(int)1);
	lime_gl_disable_vertex_attrib_array= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_disable_vertex_attrib_array"),(int)1);
	lime_gl_draw_arrays= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_draw_arrays"),(int)3);
	lime_gl_draw_elements= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_draw_elements"),(int)4);
	lime_gl_enable= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_enable"),(int)1);
	lime_gl_enable_vertex_attrib_array= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_enable_vertex_attrib_array"),(int)1);
	lime_gl_finish= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_finish"),(int)0);
	lime_gl_flush= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_flush"),(int)0);
	lime_gl_framebuffer_renderbuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_framebuffer_renderbuffer"),(int)4);
	lime_gl_framebuffer_texture2D= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_framebuffer_texture2D"),(int)5);
	lime_gl_front_face= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_front_face"),(int)1);
	lime_gl_generate_mipmap= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_generate_mipmap"),(int)1);
	lime_gl_get_active_attrib= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_active_attrib"),(int)2);
	lime_gl_get_active_uniform= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_active_uniform"),(int)2);
	lime_gl_get_attrib_location= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_attrib_location"),(int)2);
	lime_gl_get_buffer_paramerter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_buffer_paramerter"),(int)2);
	lime_gl_get_context_attributes= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_context_attributes"),(int)0);
	lime_gl_get_error= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_error"),(int)0);
	lime_gl_get_framebuffer_attachment_parameter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_framebuffer_attachment_parameter"),(int)3);
	lime_gl_get_parameter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_parameter"),(int)1);
	lime_gl_get_program_info_log= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_program_info_log"),(int)1);
	lime_gl_get_program_parameter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_program_parameter"),(int)2);
	lime_gl_get_render_buffer_parameter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_render_buffer_parameter"),(int)2);
	lime_gl_get_shader_info_log= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_shader_info_log"),(int)1);
	lime_gl_get_shader_parameter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_shader_parameter"),(int)2);
	lime_gl_get_shader_precision_format= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_shader_precision_format"),(int)2);
	lime_gl_get_shader_source= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_shader_source"),(int)1);
	lime_gl_get_supported_extensions= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_supported_extensions"),(int)1);
	lime_gl_get_tex_parameter= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_tex_parameter"),(int)2);
	lime_gl_get_uniform= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_uniform"),(int)2);
	lime_gl_get_uniform_location= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_uniform_location"),(int)2);
	lime_gl_get_vertex_attrib= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_vertex_attrib"),(int)2);
	lime_gl_get_vertex_attrib_offset= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_get_vertex_attrib_offset"),(int)2);
	lime_gl_hint= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_hint"),(int)2);
	lime_gl_is_buffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_buffer"),(int)1);
	lime_gl_is_enabled= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_enabled"),(int)1);
	lime_gl_is_framebuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_framebuffer"),(int)1);
	lime_gl_is_program= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_program"),(int)1);
	lime_gl_is_renderbuffer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_renderbuffer"),(int)1);
	lime_gl_is_shader= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_shader"),(int)1);
	lime_gl_is_texture= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_is_texture"),(int)1);
	lime_gl_line_width= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_line_width"),(int)1);
	lime_gl_link_program= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_link_program"),(int)1);
	lime_gl_pixel_storei= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_pixel_storei"),(int)2);
	lime_gl_polygon_offset= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_polygon_offset"),(int)2);
	lime_gl_read_pixels= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_read_pixels"),(int)-1);
	lime_gl_renderbuffer_storage= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_renderbuffer_storage"),(int)4);
	lime_gl_sample_coverage= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_sample_coverage"),(int)2);
	lime_gl_scissor= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_scissor"),(int)4);
	lime_gl_shader_source= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_shader_source"),(int)2);
	lime_gl_stencil_func= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_stencil_func"),(int)3);
	lime_gl_stencil_func_separate= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_stencil_func_separate"),(int)4);
	lime_gl_stencil_mask= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_stencil_mask"),(int)1);
	lime_gl_stencil_mask_separate= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_stencil_mask_separate"),(int)2);
	lime_gl_stencil_op= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_stencil_op"),(int)3);
	lime_gl_stencil_op_separate= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_stencil_op_separate"),(int)4);
	lime_gl_tex_image_2d= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_tex_image_2d"),(int)-1);
	lime_gl_tex_parameterf= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_tex_parameterf"),(int)3);
	lime_gl_tex_parameteri= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_tex_parameteri"),(int)3);
	lime_gl_tex_sub_image_2d= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_tex_sub_image_2d"),(int)-1);
	lime_gl_uniform1f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform1f"),(int)2);
	lime_gl_uniform1fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform1fv"),(int)2);
	lime_gl_uniform1i= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform1i"),(int)2);
	lime_gl_uniform1iv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform1iv"),(int)2);
	lime_gl_uniform2f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform2f"),(int)3);
	lime_gl_uniform2fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform2fv"),(int)2);
	lime_gl_uniform2i= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform2i"),(int)3);
	lime_gl_uniform2iv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform2iv"),(int)2);
	lime_gl_uniform3f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform3f"),(int)4);
	lime_gl_uniform3fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform3fv"),(int)2);
	lime_gl_uniform3i= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform3i"),(int)4);
	lime_gl_uniform3iv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform3iv"),(int)2);
	lime_gl_uniform4f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform4f"),(int)5);
	lime_gl_uniform4fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform4fv"),(int)2);
	lime_gl_uniform4i= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform4i"),(int)5);
	lime_gl_uniform4iv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform4iv"),(int)2);
	lime_gl_uniform_matrix= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_uniform_matrix"),(int)4);
	lime_gl_use_program= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_use_program"),(int)1);
	lime_gl_validate_program= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_validate_program"),(int)1);
	lime_gl_version= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_version"),(int)0);
	lime_gl_vertex_attrib1f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib1f"),(int)2);
	lime_gl_vertex_attrib1fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib1fv"),(int)2);
	lime_gl_vertex_attrib2f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib2f"),(int)3);
	lime_gl_vertex_attrib2fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib2fv"),(int)2);
	lime_gl_vertex_attrib3f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib3f"),(int)4);
	lime_gl_vertex_attrib3fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib3fv"),(int)2);
	lime_gl_vertex_attrib4f= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib4f"),(int)5);
	lime_gl_vertex_attrib4fv= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib4fv"),(int)2);
	lime_gl_vertex_attrib_pointer= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_vertex_attrib_pointer"),(int)-1);
	lime_gl_viewport= ::openfl::_legacy::gl::GL_obj::load(HX_CSTRING("lime_legacy_gl_viewport"),(int)4);
}
