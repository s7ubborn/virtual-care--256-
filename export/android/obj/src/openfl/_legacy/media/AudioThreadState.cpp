...
{
HX_STACK_FRAME("openfl._legacy.media.AudioThreadState","new",0x7864e3f1,"openfl._legacy.media.AudioThreadState.new","openfl/_legacy/media/SoundChannel.hx",342,0xd2a8ca59)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(344)
...
{
		HX_STACK_FRAME("openfl._legacy.media.AudioThreadState","add",0x785b05b2,"openfl._legacy.media.AudioThreadState.add","openfl/_legacy/media/SoundChannel.hx",352,0xd2a8ca59)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.media.AudioThreadState","remove",0x1bfd5953,"openfl._legacy.media.AudioThreadState.remove","openfl/_legacy/media/SoundChannel.hx",362,0xd2a8ca59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(channel,"channel")
		HX_STACK_LINE(364)
		this->mutex->acquire();
...
{
		HX_STACK_FRAME("openfl._legacy.media.AudioThreadState","updateComplete",0xf710d7f1,"openfl._legacy.media.AudioThreadState.updateComplete","openfl/_legacy/media/SoundChannel.hx",391,0xd2a8ca59)
		HX_STACK_THIS(this)
		HX_STACK_LINE(393)
		this->mutex->acquire();
		HX_STACK_LINE(395)
