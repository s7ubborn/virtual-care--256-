...
{
HX_STACK_FRAME("openfl._legacy.net.URLLoader","new",0xb77dde7f,"openfl._legacy.net.URLLoader.new","openfl/_legacy/net/URLLoader.hx",38,0xef414054)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","close",0xa8c42b97,"openfl._legacy.net.URLLoader.close","openfl/_legacy/net/URLLoader.hx",57,0xef414054)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","dispatchHTTPStatus",0xa730fcd5,"openfl._legacy.net.URLLoader.dispatchHTTPStatus","openfl/_legacy/net/URLLoader.hx",64,0xef414054)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(67)
		Array< ::String > headers = ::openfl::_legacy::net::URLLoader_obj::lime_curl_get_headers(this->__handle);		HX_STACK_VAR(headers,"headers");
		HX_STACK_LINE(69)
		{
			HX_STACK_LINE(69)
...
Array< ::String > URLLoader_obj::getCookies( ){
	HX_STACK_FRAME("openfl._legacy.net.URLLoader","getCookies",0x87bf411a,"openfl._legacy.net.URLLoader.getCookies","openfl/_legacy/net/URLLoader.hx",87,0xef414054)
	HX_STACK_THIS(this)
	HX_STACK_LINE(87)
	return ::openfl::_legacy::net::URLLoader_obj::lime_curl_get_cookies(this->__handle);
}
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","load",0xd559e727,"openfl._legacy.net.URLLoader.load","openfl/_legacy/net/URLLoader.hx",106,0xef414054)
		HX_STACK_THIS(this)
		HX_STACK_ARG(request,"request")
		HX_STACK_LINE(108)
		this->state = (int)1;
		...
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			...
			request->__prepare();
			HX_STACK_LINE(143)
			Dynamic _g3 = ::openfl::_legacy::net::URLLoader_obj::lime_curl_create(request);		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(143)
			this->__handle = _g3;
			HX_STACK_LINE(145)
			if (((this->__handle == null()))){
				...
				HX_STACK_LINE(151)
				::openfl::_legacy::net::URLLoader_obj::activeLoaders->push(hx::ObjectPtr<OBJ_>(this));
			}
		}
	}
return null();
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","onError",0x131c73c8,"openfl._legacy.net.URLLoader.onError","openfl/_legacy/net/URLLoader.hx",160,0xef414054)
		HX_STACK_THIS(this)
		HX_STACK_ARG(msg,"msg")
		HX_STACK_LINE(162)
		::openfl::_legacy::net::URLLoader_obj::activeLoaders->remove(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(163)
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","update",0x7b95d54a,"openfl._legacy.net.URLLoader.update","openfl/_legacy/net/URLLoader.hx",170,0xef414054)
		HX_STACK_THIS(this)
		HX_STACK_LINE(170)
		if (((this->__handle != null()))){
			HX_STACK_LINE(172)
			...
			HX_STACK_LINE(174)
			::openfl::_legacy::net::URLLoader_obj::lime_curl_update_loader(this->__handle,hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(176)
			...
			HX_STACK_LINE(188)
			int code = ::openfl::_legacy::net::URLLoader_obj::lime_curl_get_code(this->__handle);		HX_STACK_VAR(code,"code");
			HX_STACK_LINE(190)
			if (((this->state == (int)3))){
				HX_STACK_LINE(192)
				this->dispatchHTTPStatus(code);
				HX_STACK_LINE(194)
				::openfl::_legacy::utils::ByteArray bytes = ::openfl::_legacy::net::URLLoader_obj::lime_curl_get_data(this->__handle);		HX_STACK_VAR(bytes,"bytes");
				HX_STACK_LINE(196)
				{
					HX_STACK_LINE(196)
					::openfl::net::URLLoaderDataFormat _g = this->dataFormat;		HX_STACK_VAR(_g,"_g");
				...
				if (((this->state == (int)4))){
					...
					this->dispatchHTTPStatus(code);
					HX_STACK_LINE(221)
					::String _g3 = ::openfl::_legacy::net::URLLoader_obj::lime_curl_get_error_message(this->__handle);		HX_STACK_VAR(_g3,"_g3");
					HX_STACK_LINE(221)
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","__dataComplete",0x1fc1c864,"openfl._legacy.net.URLLoader.__dataComplete","openfl/_legacy/net/URLLoader.hx",232,0xef414054)
		HX_STACK_THIS(this)
		HX_STACK_LINE(234)
		::openfl::_legacy::net::URLLoader_obj::activeLoaders->remove(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(236)
...
bool URLLoader_obj::hasActive( ){
	HX_STACK_FRAME("openfl._legacy.net.URLLoader","hasActive",0xff70e41f,"openfl._legacy.net.URLLoader.hasActive","openfl/_legacy/net/URLLoader.hx",94,0xef414054)
	HX_STACK_LINE(94)
	return !(::openfl::_legacy::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","initialize",0x7e2ab511,"openfl._legacy.net.URLLoader.initialize","openfl/_legacy/net/URLLoader.hx",101,0xef414054)
		HX_STACK_ARG(caCertFilePath,"caCertFilePath")
		HX_STACK_LINE(101)
		::openfl::_legacy::net::URLLoader_obj::lime_curl_initialize(caCertFilePath);
	}
return null();
}
...
bool URLLoader_obj::__loadPending( ){
	HX_STACK_FRAME("openfl._legacy.net.URLLoader","__loadPending",0x19792290,"openfl._legacy.net.URLLoader.__loadPending","openfl/_legacy/net/URLLoader.hx",259,0xef414054)
	HX_STACK_LINE(259)
	return !(::openfl::_legacy::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
{
		HX_STACK_FRAME("openfl._legacy.net.URLLoader","__pollData",0xcd9682ea,"openfl._legacy.net.URLLoader.__pollData","openfl/_legacy/net/URLLoader.hx",266,0xef414054)
		HX_STACK_LINE(266)
		if ((!(::openfl::_legacy::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_STACK_LINE(268)
			::openfl::_legacy::net::URLLoader_obj::lime_curl_process_loaders();
			HX_STACK_LINE(269)
			::List oldLoaders = ::openfl::_legacy::net::URLLoader_obj::activeLoaders;		HX_STACK_VAR(oldLoaders,"oldLoaders");
			HX_STACK_LINE(270)
			::List _g = ::List_obj::__new();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(270)
			::openfl::_legacy::net::URLLoader_obj::activeLoaders = _g;
			HX_STACK_LINE(272)
			for(::cpp::FastIterator_obj< ::openfl::_legacy::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::openfl::_legacy::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				::openfl::_legacy::net::URLLoader loader = __it->next();
				{
					...
					if (((loader->state == (int)2))){
						HX_STACK_LINE(277)
						::openfl::_legacy::net::URLLoader_obj::activeLoaders->push(loader);
					}
				}
;
			}
