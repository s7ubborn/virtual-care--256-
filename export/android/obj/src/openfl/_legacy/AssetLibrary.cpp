...
{
HX_STACK_FRAME("openfl._legacy.AssetLibrary","new",0xef7d4161,"openfl._legacy.AssetLibrary.new","openfl/_legacy/Assets.hx",1193,0x9276b055)
HX_STACK_THIS(this)
{
}
;
...
bool AssetLibrary_obj::exists( ::String id,::openfl::_legacy::AssetType type){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","exists",0xa21c837b,"openfl._legacy.AssetLibrary.exists","openfl/_legacy/Assets.hx",1202,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
...
::openfl::_legacy::display::BitmapData AssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getBitmapData",0x1ad22e30,"openfl._legacy.AssetLibrary.getBitmapData","openfl/_legacy/Assets.hx",1209,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1209)
	return null();
...
::openfl::_legacy::utils::ByteArray AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getBytes",0x53c76354,"openfl._legacy.AssetLibrary.getBytes","openfl/_legacy/Assets.hx",1216,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1216)
	return null();
...
::openfl::_legacy::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getFont",0x28df9306,"openfl._legacy.AssetLibrary.getFont","openfl/_legacy/Assets.hx",1223,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1223)
	return null();
...
::openfl::_legacy::display::MovieClip AssetLibrary_obj::getMovieClip( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getMovieClip",0x2a5c8609,"openfl._legacy.AssetLibrary.getMovieClip","openfl/_legacy/Assets.hx",1230,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1230)
	return null();
...
::openfl::_legacy::media::Sound AssetLibrary_obj::getMusic( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getMusic",0xa68a2b8e,"openfl._legacy.AssetLibrary.getMusic","openfl/_legacy/Assets.hx",1237,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1237)
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getPath",0x2f711adc,"openfl._legacy.AssetLibrary.getPath","openfl/_legacy/Assets.hx",1244,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1244)
	return null();
...
::openfl::_legacy::media::Sound AssetLibrary_obj::getSound( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getSound",0x16fbe7b8,"openfl._legacy.AssetLibrary.getSound","openfl/_legacy/Assets.hx",1251,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1251)
	return null();
...
::String AssetLibrary_obj::getText( ::String id){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","getText",0x321901e4,"openfl._legacy.AssetLibrary.getText","openfl/_legacy/Assets.hx",1256,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1260)
...
bool AssetLibrary_obj::isLocal( ::String id,::openfl::_legacy::AssetType type){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","isLocal",0x2812f2a2,"openfl._legacy.AssetLibrary.isLocal","openfl/_legacy/Assets.hx",1283,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(1283)
...
Array< ::String > AssetLibrary_obj::list( ::openfl::_legacy::AssetType type){
	HX_STACK_FRAME("openfl._legacy.AssetLibrary","list",0x9ccc8c3d,"openfl._legacy.AssetLibrary.list","openfl/_legacy/Assets.hx",1290,0x9276b055)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(1290)
	return null();
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","load",0x9cd10a05,"openfl._legacy.AssetLibrary.load","openfl/_legacy/Assets.hx",1297,0x9276b055)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadBitmapData",0x8b0b5c1e,"openfl._legacy.AssetLibrary.loadBitmapData","openfl/_legacy/Assets.hx",1302,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1304)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadBytes",0x2fb8fc26,"openfl._legacy.AssetLibrary.loadBytes","openfl/_legacy/Assets.hx",1309,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1311)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadFont",0xeab87a74,"openfl._legacy.AssetLibrary.loadFont","openfl/_legacy/Assets.hx",1316,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1318)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadMovieClip",0x251fefdb,"openfl._legacy.AssetLibrary.loadMovieClip","openfl/_legacy/Assets.hx",1323,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1325)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadMusic",0x827bc460,"openfl._legacy.AssetLibrary.loadMusic","openfl/_legacy/Assets.hx",1330,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1332)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadSound",0xf2ed808a,"openfl._legacy.AssetLibrary.loadSound","openfl/_legacy/Assets.hx",1337,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1339)
...
{
		HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadText",0xf3f1e952,"openfl._legacy.AssetLibrary.loadText","openfl/_legacy/Assets.hx",1344,0x9276b055)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1344)
		...
		Void run(::openfl::_legacy::utils::ByteArray bytes){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/_legacy/Assets.hx",1350,0x9276b055)
