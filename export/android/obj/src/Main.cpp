...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(14)
	this->gameHeight = (int)3072;
	HX_STACK_LINE(13)
	this->gameWidth = (int)4096;
	HX_STACK_LINE(32)
	super::__construct();
	HX_STACK_LINE(34)
...
{
		HX_STACK_FRAME("Main","init",0xea732345,"Main.init","Main.hx",45,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(E,"E")
		HX_STACK_LINE(46)
...
{
		HX_STACK_FRAME("Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",55,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(56)
...
Void Main_obj::main( ){
{
		HX_STACK_FRAME("Main","main",0xed0e206e,"Main.main","Main.hx",26,0x087e5c05)
		HX_STACK_LINE(27)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(Main_obj,playerChosen),HX_CSTRING("playerChosen")},
	{ hx::fsUnknown, 0, null()}
};
#endif
