...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(25)
		::openfl::_legacy::Lib_obj::setPackage(HX_CSTRING("Team Omega Fucus"),HX_CSTRING("Virtual care"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
