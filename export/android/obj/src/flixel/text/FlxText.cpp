...
Void FlxText_obj::removeFormat( ::flixel::text::FlxTextFormat Format){
{
		...
		HX_STACK_LINE(273)
		{
			...
			HX_STACK_LINE(273)
			int index = array->indexOf(Format,null());		HX_STACK_VAR(index,"index");
			HX_STACK_LINE(273)
			if (((index != (int)-1))){
				HX_STACK_LINE(273)
...
bool FlxText_obj::set_autoSize( bool value){
	...
	if (((this->_textField != null()))){
		...
		if ((value)){
			HX_STACK_LINE(450)
			this->_textField->set_autoSize(::openfl::text::TextFieldAutoSize_obj::LEFT);
		}
		else{
			HX_STACK_LINE(452)
			this->_textField->set_autoSize(::openfl::text::TextFieldAutoSize_obj::NONE);
		}
		HX_STACK_LINE(454)
		this->dirty = true;
	}
...
bool FlxText_obj::get_autoSize( ){
	...
	if (((this->_textField != null()))){
		HX_STACK_LINE(462)
		::openfl::text::TextFieldAutoSize _g = this->_textField->get_autoSize();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(462)
