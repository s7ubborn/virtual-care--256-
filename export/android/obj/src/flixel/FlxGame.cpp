...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(305)
		this->get_stage()->addEventListener(::openfl::_legacy::events::Event_obj::DEACTIVATE,this->onFocusLost_dyn(),null(),null(),null());
		HX_STACK_LINE(306)
		this->get_stage()->addEventListener(::openfl::_legacy::events::Event_obj::ACTIVATE,this->onFocus_dyn(),null(),null(),null());
		HX_STACK_LINE(310)
		{
			HX_STACK_LINE(310)
		...
		HX_STACK_LINE(326)
		int _g5 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(326)
		int _g6 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(326)
