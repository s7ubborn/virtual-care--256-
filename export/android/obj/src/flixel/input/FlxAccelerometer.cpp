...
HX_STACK_THIS(this)
{
	...
	if ((::openfl::_legacy::sensors::Accelerometer_obj::get_isSupported())){
		HX_STACK_LINE(39)
		::openfl::_legacy::sensors::Accelerometer _g = ::openfl::_legacy::sensors::Accelerometer_obj::__new();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(39)
		this->_sensor = _g;
		HX_STACK_LINE(40)
...
bool FlxAccelerometer_obj::get_isSupported( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(46)
	return ::openfl::_legacy::sensors::Accelerometer_obj::get_isSupported();
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::sensors::Accelerometer*/ ,(int)offsetof(FlxAccelerometer_obj,_sensor),HX_CSTRING("_sensor")},
	{ hx::fsUnknown, 0, null()}
};
#endif
