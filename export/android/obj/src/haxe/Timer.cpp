...
Void run(){
{
		HX_STACK_FRAME("haxe.Timer","run",0x4139c7ba,"haxe.Timer.run","haxe/Timer.hx",265,0x1a690682)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void Timer_obj::stop( ){
{
		HX_STACK_FRAME("haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","haxe/Timer.hx",285,0x1a690682)
		HX_STACK_THIS(this)
		HX_STACK_LINE(285)
		if ((this->mRunning)){
			HX_STACK_LINE(287)
...
{
		HX_STACK_FRAME("haxe.Timer","__check",0xb5623597,"haxe.Timer.__check","haxe/Timer.hx",307,0x1a690682)
		HX_STACK_THIS(this)
...
Dynamic Timer_obj::measure( Dynamic f,Dynamic pos){
	HX_STACK_FRAME("haxe.Timer","measure",0x42373f4d,"haxe.Timer.measure","haxe/Timer.hx",255,0x1a690682)
	HX_STACK_ARG(f,"f")
...
Float Timer_obj::stamp( ){
	HX_STACK_FRAME("haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",275,0x1a690682)
	HX_STACK_LINE(275)
...
{
		HX_STACK_FRAME("haxe.Timer","__checkTimers",0xb7078205,"haxe.Timer.__checkTimers","haxe/Timer.hx",317,0x1a690682)
		HX_STACK_LINE(319)
		...
		if ((foundNull)){
			...
			bool run(::haxe::Timer val){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","haxe/Timer.hx",339,0x1a690682)
...
Float Timer_obj::__nextWake( Float limit){
	HX_STACK_FRAME("haxe.Timer","__nextWake",0x0e101148,"haxe.Timer.__nextWake","haxe/Timer.hx",347,0x1a690682)
